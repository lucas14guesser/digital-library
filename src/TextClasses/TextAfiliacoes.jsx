      ...
      <div className="conteudo-afiliacoes">
        <Card>
          ...
          <Card.Body>
              ...
              <Link to='/pequenos-cristos' className='link-btn'>Clique para saber mais</Link>
            </Card.Body>
        </Card>
        <Card>
          ...
          <Card.Body>
              ...
              <Link to='/psicanalise-e-racismo' className='link-btn'>Clique para saber mais</Link>
            </Card.Body>
        </Card>
        <Card>
          ...
          <Card.Body>
              ...
              <Link to='/verdadeiro-cristao' className='link-btn'>Clique para saber mais</Link>
            </Card.Body>
        </Card>
      </div>
      <div className="conteudo-afiliacao__banner">
        <Card className='conteudo-afiliacao__banner__card'>
          ...
          <Card.Body>
              ...
              <Link to='/daqui-um-ano-voce-vai-desejar-ter-comecado-hoje' className='link-btn'>Clique para saber mais</Link>
            </Card.Body>
        </Card>
      </div>
    </Container>
